({	
    sortTable : function (component, event, helper) {
        ...
        if (column!=null){
            ...
            table = document.getElementById("DollarsTable");
            switching = true;
    ...
    showEditBox : function(component, event, helper) {
        if (component.get("v.isCommunityUser") == false || (component.get("v.isCommunityUser") == true && component.get("v.isAllowEditing") == true)){
            ...
            if(Array.isArray(editBoxes)){
                ...
                setTimeout(function() {component.find("editBoxInput")[targetIndex].getElement().focus();},10); 
            } else {
                $A.util.removeClass(editBoxes, "slds-hide");
                $A.util.addClass(editBoxes, "slds-show");
                setTimeout(function() {component.find("editBoxInput").getElement().focus();},10); 
            }
        }
    },
