    ...
    initDatatable : function(component, rawCapTableData) {
        ...
        for (var round of rawCapTableData.rounds) {
            columns.push({
                ...
                data:       round.id + "numberOfSharesVoting",
        ...
        columns.push({
            title: "Total:",
            data: "totalSharesVotingForInvestor",
            render: numberFormatter,
            className: 'dt-body-right dt-head-center'
        });
        ...
        $(document).ready(function() {
            ...
            var datatableId = 'dtableBySharesVoting' + timestamp;
            $('#dtableBySharesVoting').prop('id', datatableId);
