({	
    ...
    AllowEditingChange: function(component, event) {
        var action = component.get("c.AllowEditingUpdate");
        action.setParams({ accountId : component.get("v.recordId"), AllowEditing : component.get("v.isAllowEditing") });
        action.setCallback(this, function(response){
            var state = response.getState();
